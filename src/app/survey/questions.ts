...
export const SURVEY_QUESTIONS: SurveyQuestion[] = [
  ...
  },
  {
    ...
    index: "04",
    section: "The idea",
    text: "How useful would a lifestyle and wellness companion for long-haul crew be for you?",
    sub: "Not medical advice — a personal tool that works with your roster and sleep science.",
    scaleMin: "Not useful",
  ...
  },
  {
    ...
    index: "12",
    section: "Trust",
    text: "Would knowing the app was built by a fellow crew member make you more likely to trust it?",
    sub: "",
